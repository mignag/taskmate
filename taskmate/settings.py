...
SECRET_KEY = env("DJANGO_SECRET_KEY")   #'django-insecure-sc_$_@5$myxuy6p(x-7*hckyi6pbeo0#^)y&ae1q$dz#!-jwfs'
...
DATABASES = {
    'default': {
        #BD posgreSQL tem que estar a correr no docker (ou o serviço local ativo)
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': env("DJANGO_DB_NAME"),   #'postgres',
        'USER': env("DJANGO_DB_USER"),   #'postgres',
        'PASSWORD': env("DJANGO_DB_PASS"),   #'1234567!',
